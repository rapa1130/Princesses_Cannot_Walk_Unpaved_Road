...
namespace Bisang
{
    void AssetSettings::Apply(ResourceManager* resourceManager)
    {
		...
		resourceManager->LoadTexture(L"Assets/Textures/Characters/Player/HandsUp/Player_HandsUp_Front.png")->SetPivot(playerTexPivot);
		resourceManager->LoadTexture(L"Assets/Textures/Characters/Player/HandsUp/Player_HandsUp_Back.png")->SetPivot(playerTexPivot);
		resourceManager->LoadTexture(L"Assets/Textures/Characters/Player/HandsUp/Player_HandsUp_Left.png")->SetPivot(playerTexPivot);
		resourceManager->LoadTexture(L"Assets/Textures/Characters/Player/HandsUp/Player_HandsUp_Right.png")->SetPivot(playerTexPivot);
		resourceManager->LoadTexture(L"Assets/Textures/Characters/Player/HandsUp/Player_HandsUp_BackLeft.png")->SetPivot(playerTexPivot);
		resourceManager->LoadTexture(L"Assets/Textures/Characters/Player/HandsUp/Player_HandsUp_BackRight.png")->SetPivot(playerTexPivot);
		resourceManager->LoadTexture(L"Assets/Textures/Characters/Player/HandsUp/Player_HandsUp_FrontLeft.png")->SetPivot(playerTexPivot);
		resourceManager->LoadTexture(L"Assets/Textures/Characters/Player/HandsUp/Player_HandsUp_FrontRight.png")->SetPivot(playerTexPivot);
